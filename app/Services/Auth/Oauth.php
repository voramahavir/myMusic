...
class Oauth {
     ...
     */
    public function __construct(SocialiteFactory $socialite, User $user, UserRepository $userCreator, Settings $settings)
    {
        $this->user = $user;
    ...
    public function attachProfileToExistingUser($user, $profile, $service)
    {
        ...
        return $this->getPopupResponse('SUCCESS_CONNECTED', ['user' => $user->load('social_profiles', 'groups')->toArray()]);
    }
